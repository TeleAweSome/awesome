      ...
      local receiver = "chat#id"..chat_id
       if get_cmd == "kick" then
         if member_id == from_id then
             return send_large_msg("شما قادر به کیک کردن نیستید")
         end
         if is_momod2(member_id, chat_id) and not is_admin2(sender) then
            return send_large_msg(receiver, "شما قادر به کیک کردن این افراد نیستید mods/owner/admins")
         end
